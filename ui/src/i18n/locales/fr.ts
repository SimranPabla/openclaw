...
export const fr: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Affichez la dernière activité de l'assistant ou des outils sous les sessions en cours.",
    },
    connection: {
      title: "Connexion",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    apps: "Applications compagnons pour téléphone, montre, bureau et navigateur.",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange:
        "Mise en forme ou commentaires modifiés sans changement visible du chemin de configuration.",
      sources: {
    ...
    nudge: {
      ...
      channelAuth: "Authentification {channel} dégradée — demandez-moi ce qui s'est passé",
  ...
  sessionsPage: {
    hubTablistLabel: "Sections de threads",
  },
  pluginsPage: {
  ...
  labsPage: {
    intro:
      "Labs contient des fonctionnalités expérimentales qui peuvent changer, cesser de fonctionner ou disparaître entre les versions.",
  ...
  appsPage: {
    ...
    pairDevice: "Appairer votre appareil",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Consultez vos discussions et répondez rapidement depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      plugins: {
        ...
        desc: "Étendez OpenClaw avec des canaux, outils et Skills de la communauté.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "Nom d'affichage",
      displayNameDescription: "Visible par les autres personnes utilisant ce gateway.",
  ...
  board: {
    ...
    actionInProgress: "Une autre modification du tableau de bord est en cours d'enregistrement.",
    announcement: {
      moved: "{title} déplacé.",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Raccord vue tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
    ...
    messages: {
      ...
      rewind: "Rembobiner",
      rewindConfirm: "Rembobiner à avant ce message ?",
    ...
    modelControls: {
      ...
      resetToDefault: "Réinitialiser par défaut ({model})",
    },
    sideChat: {
    ...
    composer: {
      ...
      holdToRecordSetting: "Maintenez le bouton micro pour dicter",
      holdToRecordSettingDescription:
        "Maintenez le bouton micro du compositeur, parlez, puis relâchez pour insérer le texte sans l'envoyer.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "Ce widget doit être régénéré pour être exporté en image.",
