...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "Архівовано {count} гілок",
    deleteAllArchived: "Видалити всі архівовані…",
    deleteAllArchivedConfirm: "Видалити {count} архівованих гілок та їхні транскрипти?",
    ...
    runFailedReason: "Помилка виконання: {reason}",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображатиметься під час запущених сесій.",
      liveActivity: "Показувати активність агента в бічній панелі в реальному часі",
      liveActivityHint:
        "Показувати останню активність асистента або інструмента під запущеними сесіями.",
    },
    connection: {
      title: "Підключення",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    reviewRequest: "Розглянути схвалення від {agent}: {command}",
  ...
  subtitles: {
    ...
    apps: "Супутні застосунки для телефону, годинника, комп'ютера та браузера.",
  ...
  labsPage: {
    ...
    restartRequired: "Потрібне перезапуск Gateway.",
  ...
  appsPage: {
    ...
    pairDevice: "Прив’яжіть свій пристрій",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся, розмовляйте, схвалюйте дії та діліться в OpenClaw з iOS.",
      },
      android: {
        title: "Android",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Застосунок-компаньйон для Android розширює OpenClaw на ваш годинник.",
      },
      macos: {
        title: "macOS",
        desc: "Компаньйон у рядку меню для вашого Gateway — сповіщення, схвалення, швидкий чат.",
      },
      windows: {
        title: "Windows",
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "Завантаження вашої особистості…",
      profileUnavailable: "Не вдалося завантажити профіль вашої особистості.",
      avatar: "Аватар",
  ...
  board: {
    ...
    emptyHint: "Ваш агент може закріпити тут віджети — спробуйте попросити картку стану.",
    ...
    widget: {
      cellLabel:
        "Віджет панелі: {title}. Використовуйте стрілки для навігації. Утримуйте Alt і натисніть стрілку, щоб перемістити його.",
      ...
      needsApprovalDetail: "Цей віджет запитав додатковий доступ.",
      allow: "Дозволити",
      reject: "Відхилити",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin:
        "Перемикання гілок потребує адміністраторського доступу оператора.",
    ...
    board: {
      ...
      defaultTab: "Головна",
      mockPlaceholder: "Шов вигляду дошки · {tabs} вкладок · {widgets} віджетів",
      mockOverview: "Огляд",
    ...
    questions: {
      ...
      answered: "Відповідь отримано",
      answeredElsewhere: "Відповідь надано деінде",
      unavailable: "Недоступно",
      expired: "Застарів",
      cancelled: "Скасовано",
    },
    ...
    modelControls: {
      ...
      usingDefault: "Використовується типове з Налаштувань",
    ...
    composer: {
      ...
      microphoneAppliesNextSession: "Зміни застосуються, коли ви почнете наступну сесію Talk.",
      ...
      holdToRecordSettingDescription:
        "Утримуйте кнопку мікрофона у полі вводу, говоріть, потім відпустіть, щоб вставити текст без надсилання.",
      ...
      dictationFailed: "Диктування не вдалося.",
      dictationFinalizing: "Завершення диктування…",
      dictationFinalizationTimedOut:
        "Диктування зупинено до того, як останній частковий транскрипт міг бути завершений.",
      ...
      selectedCameraUnavailable:
        "Вибрана камера недоступна. Виберіть іншу камеру або System default.",
    ...
    toolCards: {
      ...
      pinToDashboard: "Закріпити на дашборді",
    ...
    sessionDiscussion: {
      ...
      opened: "Обговорення сесії",
      openExternal: "Відкрити обговорення в новій вкладці",
      frameTitle: "Обговорення сесії",
