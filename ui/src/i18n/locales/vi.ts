...
export const vi: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp nào được lưu bị xóa. Nó có thể đã không còn, hoặc thư mục xác thực của nó có thể cần được dọn dẹp thủ công.",
    },
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Có bảng điều khiển",
    approvalNeeded: "Cần phê duyệt",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG hoặc WebP. Hình ảnh được cắt ở giữa và đổi kích thước thành 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Thông báo đang bị tắt cho OpenClaw trong macOS. Cho phép chúng trong Cài đặt Hệ thống > Thông báo.",
    },
    appearance: {
      theme: "Giao diện",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Những gì đã thay đổi trên hệ thống này, mới nhất trước tiên.",
    ...
    nudge: {
      configReload: "Tải lại cấu hình đã dừng — hãy hỏi tôi chuyện gì đã xảy ra",
      ...
      channelDegraded: "{channel} đang suy giảm — hãy hỏi tôi chuyện gì đã xảy ra",
  ...
  mcpServers: {
    ...
    nameInvalid: "Tên máy chủ dùng chữ cái, số, dấu chấm, gạch ngang hoặc gạch dưới.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép agent kết hợp các công cụ trong quy trình JavaScript gọn nhẹ, được cô lập.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Trò chuyện, gọi thoại, phê duyệt hành động và chia sẻ vào OpenClaw từ iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh cuộc trò chuyện và trả lời nhanh ngay từ cổ tay của bạn.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        ...
        tooLarge: "Avatar đã xử lý lớn hơn 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    emptyHint: "Agent của bạn có thể ghim widget vào đây — hãy thử yêu cầu một thẻ trạng thái.",
    ...
    widget: {
      ...
      needsApprovalDetail: "Tiện ích này yêu cầu quyền truy cập bổ sung.",
      allow: "Cho phép",
      reject: "Từ chối",
      ...
      frameAuthorizationFailed: "Ủy quyền tiện ích thất bại sau nhiều lần thử làm mới.",
      errorTitle: "Không thể tải tiện ích này",
      errorDetail: "Sự cố chỉ giới hạn trong thẻ này.",
      actionErrorTitle: "Thay đổi tiện ích thất bại",
      actionErrorDetail: "Bảng điều khiển giữ lại trạng thái tiện ích trước đó.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Chuyển nhánh yêu cầu quyền quản trị của người vận hành.",
    ...
    board: {
      ...
      resizeDock: "Thay đổi kích thước ngăn trò chuyện",
      ...
      mockRecentFindings: "Kết quả gần đây",
      mockSourceMap: "Bản đồ nguồn",
      resetTitle: "Đặt lại cuộc trò chuyện?",
      resetDescription:
        "Ngữ cảnh cuộc trò chuyện sẽ được đặt lại. Bảng điều khiển của bạn vẫn được giữ lại.",
    },
    catalog: {
    ...
    messages: {
      activity: "Hoạt động",
      forkFromHere: "Phân nhánh từ đây",
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Trợ lý vẫn thấy nó.",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Giữ nút micrô trên khung soạn thảo, nói, rồi thả ra để chèn văn bản mà không gửi.",
      dictationAudioUnsupported:
        "Gateway trả về định dạng âm thanh đọc chính tả không được hỗ trợ.",
      ...
      dictationFinalizationTimedOut:
        "Đọc chính tả đã dừng trước khi bản ghi tạm cuối cùng được hoàn tất.",
