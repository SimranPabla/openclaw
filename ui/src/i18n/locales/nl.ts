...
export const nl: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count} gearchiveerde threads en hun transcripten verwijderen?",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint: "Toon de laatste assistent- of toolactiviteit onder actieve sessies.",
    },
    connection: {
      title: "Verbinding",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    labs: "Experimentele agent- en toolfuncties.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} is zojuist verbroken — vraag me wat er is gebeurd",
  ...
  mcpPage: {
    connectorsLink: "Ontdek connectoren met één klik op de pagina Plugins.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Gefilterd",
  ...
  sessionsPage: {
    hubTablistLabel: "Thread-secties",
  },
  pluginsPage: {
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele functies die tussen releases kunnen wijzigen, kapotgaan of verdwijnen.",
    sectionTitle: "Experimentele functies",
    sectionDescription:
      "Wijzigingen worden direct opgeslagen en toegepast op toekomstige agentruns.",
    ...
    codeMode: {
      title: "Code Mode",
      description: "Laat agents tools combineren in compacte, sandbox-JavaScript-workflows.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "Companion-apps voor je telefoon, horloge, desktop en browser — plus plug-ins om uit te breiden wat je agent kan doen.",
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "De Android-metgezel breidt OpenClaw uit naar je horloge.",
      },
      macos: {
        title: "macOS",
        desc: "Menubalk-metgezel voor je Gateway — meldingen, goedkeuringen, snelle chat.",
      },
      windows: {
        title: "Windows",
        desc: "De Windows-metgezel verbindt je pc als OpenClaw-node.",
      },
      linux: {
        title: "Linux",
      ...
      plugins: {
        ...
        desc: "Breid OpenClaw uit met kanalen, tools en Skills uit de community.",
      },
    },
  },
  presence: {
  ...
  board: {
    ...
    widget: {
      ...
      frameAuthorizationFailed: "Widgetautorisatie is mislukt na herhaalde verversingspogingen.",
  ...
  chat: {
    ...
    board: {
      ...
      resetDescription: "De gesprekscontext wordt opnieuw ingesteld. Je dashboard blijft.",
    },
    catalog: {
    ...
    modelControls: {
      ...
      reasoning: "Redenering",
      speed: "Snelheid",
      sessionOverride: "Threadoverschrijving",
    ...
    composer: {
      ...
      dictationAudioUnsupported:
        "De Gateway heeft een niet-ondersteund audioformaat voor dictaten geretourneerd.",
      dictationBrowserAudioUnsupported: "Deze browser kan geen dicteeraudio op 8 kHz vastleggen.",
      ...
      selectedCameraUnavailable:
        "De geselecteerde camera is niet beschikbaar. Kies een andere camera of de systeemstandaard.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget-export mislukt. Probeer opnieuw.",
    ...
    sessionDiscussion: {
      ...
      openExternal: "Discussie in een nieuw tabblad openen",
