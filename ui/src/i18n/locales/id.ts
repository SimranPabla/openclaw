...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Keluar.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Mungkin sudah tidak ada, atau direktori auth-nya perlu dibersihkan secara manual.",
    },
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Apa yang berubah pada sistem ini, terbaru dulu.",
  ...
  sessionsPage: {
    hubTablistLabel: "Bagian threads",
  },
  pluginsPage: {
  ...
  labsPage: {
    ...
    sectionDescription: "Perubahan langsung disimpan dan berlaku untuk operasi agen berikutnya.",
    documentation: "Dokumentasi",
    restartRequired: "Perlu memulai ulang Gateway.",
    ...
    swarm: {
      title: "Swarm",
      description: "Biarkan Code Mode mengorkestrasi kelompok subagen secara paralel.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Beralih branch memerlukan akses admin operator.",
    ...
    messages: {
      activity: "Aktivitas",
      forkFromHere: "Bercabang dari sini",
      hide: "Sembunyikan",
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Dikte berhenti sebelum transkrip parsial terakhir dapat difinalisasi.",
