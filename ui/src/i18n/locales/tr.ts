...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı bir WhatsApp oturumu temizlenmedi. Zaten mevcut olmayabilir veya kimlik doğrulama dizininin elle temizlenmesi gerekebilir.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Bulut çalışanları OpenClaw çalışma zamanını gerektirir; {runtime} seçildi.",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count} arşivlenmiş iş parçacığı ve dökümleri silinsin mi?",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görseller ortadan kırpılır ve 512 piksele yeniden boyutlandırılır.",
      profileLoadFailed: "Profiliniz yüklenemedi.",
      profileSaveFailed: "Profiliniz kaydedilemedi.",
      avatarInvalid: "Geçerli bir JPEG, PNG veya WebP görsel seçin.",
  ...
  configView: {
    ...
    syncedHint: "Gateway üzerinden cihazlarınız arasında senkronize edilir.",
    notifications: {
      ...
      nativeBlockedHint:
        "OpenClaw için macOS'te bildirimler devre dışı. Bunlara Sistem Ayarları > Bildirimler'den izin verin.",
    },
    appearance: {
      theme: "Tema",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} bozuldu — bana ne olduğunu sorun",
  ...
  mcpServers: {
    ...
    nameInvalid: "Sunucu adları harf, rakam, nokta, tire veya alt çizgi içerir.",
  ...
  mcpPage: {
    connectorsLink: "Tek tıkla bağlanan konektörleri Plugins sayfasında keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Değişiklikler anında kaydedilir ve gelecekteki ajan çalıştırmalarına uygulanır.",
    documentation: "Belgeler",
    restartRequired: "Gateway yeniden başlatılmalı.",
    saveErrorTitle: "Özellik güncellenemedi",
    saveFailed: "Özellik ayarı kaydedilemedi.",
    codeMode: {
      title: "Code Mode",
      description:
        "Ajanların araçları kompakt, korumalı JavaScript iş akışlarında birleştirmesini sağlayın.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode'un alt ajan gruplarını paralel olarak yönetmesini sağlayın.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Telefonunuz, saatiniz, masaüstünüz ve tarayıcınız için tamamlayıcı uygulamalar — ayrıca ajanınızın yapabileceklerini genişleten eklentiler.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS'tan sohbet edin, konuşun, işlemleri onaylayın ve OpenClaw'a paylaşın.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Bileğinizden hızlıca göz atılabilen sohbetler ve hızlı yanıtlar.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android yardımcı uygulaması OpenClaw'u saatinize genişletir.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Windows yardımcısı, PC'nizi bir OpenClaw düğümü olarak bağlar.",
      },
      linux: {
        title: "Linux",
  ...
  presence: {
    rosterLabel: "Kimin çevrimiçi olduğunu göster",
  ...
  board: {
    ...
    emptyHint: "Ajanınız buraya widget'lar sabitleyebilir — bir durum kartı isteyin.",
    ...
    widget: {
      cellLabel:
        "Kontrol paneli bileşeni: {title}. Gezinmek için ok tuşlarını kullanın. Taşımak için Alt tuşunu basılı tutup bir ok tuşuna basın.",
      moveHandle: "{title} bileşenini taşı",
      resizeHandle: "{title} bileşenini yeniden boyutlandır",
      ...
      needsApprovalDetail: "Bu bileşen ek erişim talep etti.",
      allow: "İzin ver",
      reject: "Reddet",
      rejected: "Erişim reddedildi",
      rejectedDetail: "Bu bileşen kaldırılana veya değiştirilene kadar etkin olmayacaktır.",
      frameResolverMissing: "Bileşen içeriği kullanılamıyor.",
      frameAuthorizationFailed:
        "Yinelenen yenileme denemelerinden sonra bileşen yetkilendirmesi başarısız oldu.",
      errorTitle: "Bu bileşen yüklenemedi",
      errorDetail: "Sorun bu kartla sınırlıdır.",
      actionErrorTitle: "Bileşen değişikliği başarısız oldu",
      actionErrorDetail: "Kontrol paneli önceki bileşen durumunu korudu.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Dal değiştirmek operatör yönetici erişimi gerektirir.",
    ...
    board: {
      ...
      defaultTab: "Ana",
      mockPlaceholder: "Pano görünümü ek yeri · {tabs} sekme · {widgets} widget",
    ...
    modelControls: {
      ...
      usingDefault: "Ayarlar'dan varsayılan kullanılıyor",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Metni göndermeden eklemek için oluşturucu mikrofon düğmesini basılı tutun, konuşun, ardından bırakın.",
      ...
      dictationDisconnected: "Gateway bağlantısı kesildiği için dikte durdu.",
      dictationFailed: "Dikte başarısız oldu.",
      dictationFinalizing: "Dikte tamamlanıyor…",
      dictationFinalizationTimedOut: "Son kısmi transkript tamamlanmadan dikte durdu.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget dışa aktarımı başarısız. Tekrar deneyin.",
