...
export const es: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "No se borró ninguna sesión de WhatsApp almacenada. Puede que ya no exista o que su directorio de autenticación requiera una limpieza manual.",
    },
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Mostrar la actividad del agente en vivo en la barra lateral",
      liveActivityHint:
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Qué cambió en este sistema, lo más reciente primero.",
  ...
  labsPage: {
    intro:
      "Labs contiene funciones experimentales que pueden cambiar, fallar o desaparecer entre versiones.",
  ...
  appsPage: {
    ...
    ctaOpenPlugins: "Abrir complementos",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats visibles de un vistazo y respuestas rápidas desde tu muñeca.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    actionInProgress: "Todavía se está guardando otro cambio del panel.",
    announcement: {
    ...
    widget: {
      ...
      actionErrorTitle: "El cambio del widget falló",
  ...
  chat: {
    ...
    composer: {
      ...
      cameraInput: "Cámara",
      cameraListUnsupported: "Este navegador no puede listar cámaras.",
      ...
      holdToRecordSettingDescription:
        "Mantén pulsado el botón del micrófono del redactor, habla y luego suelta para insertar texto sin enviarlo.",
    ...
    toolCards: {
      ...
      widgetActions: "Acciones de widget",
      ...
      pinToDashboard: "Anclar al panel",
      pinToDashboardPending: "Anclando…",
    ...
    sessionDiscussion: {
      ...
      openExternal: "Abrir discusión en una nueva pestaña",
