...
export const fa: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "خارج شد.",
      logoutNotCleared:
        "هیچ نشست ذخیره‌شده WhatsApp پاک نشد. ممکن است از قبل موجود نباشد، یا پوشه احراز هویت آن نیاز به پاک‌سازی دستی داشته باشد.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "کارگرهای ابری به runtime OpenClaw نیاز دارند؛ {runtime} انتخاب شده است.",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count} رشته بایگانی‌شده و رونوشت‌های آن‌ها حذف شود؟",
    ...
    attentionRequired: "نشست به توجه نیاز دارد",
    model: "مدل",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "نوار کناری",
      hint: "انتخاب کنید هنگام اجرای جلسات چه چیزی نمایش داده شود.",
      liveActivity: "نمایش فعالیت زنده عامل در نوار کناری",
      liveActivityHint: "آخرین فعالیت دستیار یا ابزار را زیر جلسات در حال اجرا نمایش می‌دهد.",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    security: "احراز هویت Gateway، سیاست exec، پروفایل ابزار و تأییدها.",
  ...
  custodian: {
    ...
    history: {
      button: "تاریخچه",
      title: "تغییرات اخیر",
      description: "چه چیزی روی این سیستم تغییر کرد، جدیدترین ابتدا.",
      ...
      opaqueChange: "قالب‌بندی یا کامنت‌ها بدون تغییر قابل مشاهده در مسیر پیکربندی تغییر کردند.",
      sources: {
  ...
  mcpServers: {
    ...
    nameTaken: "سروری با نام «{name}» از قبل وجود دارد.",
  ...
  labsPage: {
    ...
    saveErrorTitle: "به‌روزرسانی قابلیت ممکن نشد",
  ...
  appsPage: {
    heroTitle: "OpenClaw را همه‌جا همراه داشته باشید",
    heroTagline:
      "اپ‌های همراه برای گوشی، ساعت، دسکتاپ و مرورگر شما — به‌همراه افزونه‌هایی برای گسترش توانایی‌های عامل شما.",
    ...
    badgeBundledIos: "همراه با اپ iOS",
    badgeBundledAndroid: "همراه با اپ Android",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "از iOS چت کنید، صحبت کنید، اقدامات را تأیید کنید و در OpenClaw به اشتراک بگذارید.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "چت‌های سریع و پاسخ‌های فوری از روی مچ دست شما.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      chrome: {
        title: "افزونه Chrome",
        desc: "به OpenClaw اجازه دهید Chrome موجود شما را کنترل کند — تب‌ها، صفحه‌ها و فرم‌ها.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "در حال بارگیری هویت شما…",
      profileUnavailable: "نمایه هویتی شما بارگیری نشد.",
      avatar: "آواتار",
      avatarDescription:
      ...
      displayName: "نام نمایشی",
      displayNameDescription: "برای سایر افرادی که از این gateway استفاده می‌کنند نمایش داده می‌شود.",
  ...
  board: {
    ...
    actionInProgress: "تغییر داشبورد دیگری هنوز در حال ذخیره است.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "ابزارک داشبورد: {title}. برای پیمایش از کلیدهای جهت‌دار استفاده کنید. برای جابجایی، Alt را نگه دارید و یک کلید جهت‌دار را فشار دهید.",
      ...
      needsApprovalDetail: "این ویجت درخواست دسترسی اضافی کرد.",
      allow: "اجازه دادن",
      reject: "رد کردن",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "هنگام کار کردن عامل، جابجایی شاخه در دسترس نیست.",
      branchSwitchRequiresAdmin: "جابجایی شاخه نیازمند دسترسی مدیریت اپراتور است.",
    ...
    board: {
      ...
      dockMenu: "پایانه گفت‌وگو: {dock}",
      dockLeft: "قرار دادن گفت‌وگو در چپ",
      dockRight: "قرار دادن گفت‌وگو در راست",
      dockBottom: "قرار دادن گفت‌وگو در پایین",
      dockHidden: "پنهان کردن گفت‌وگو",
      resizeDock: "تغییر اندازه پایانه گفت‌وگو",
      reopenChat: "نمایش گفت‌وگو",
      defaultTab: "اصلی",
      mockPlaceholder: "درز نمای برد · {tabs} زبانه · {widgets} ابزارک",
    ...
    composer: {
      ...
      dictationFinalizing: "در حال پایان دیکته…",
    ...
    sessionDiscussion: {
      ...
      show: "نمایش بحث",
      disconnected: "Gateway قطع است.",
      loading: "در حال بارگذاری بحث…",
      open: "باز کردن گفتگو",
      opening: "در حال باز کردن گفتگو…",
      opened: "گفتگوی نشست",
      openExternal: "باز کردن گفتگو در برگه جدید",
