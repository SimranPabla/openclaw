...
export const pl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie wyczyszczono żadnej zapisanej sesji WhatsApp. Może już nie istnieć lub jej katalog uwierzytelniania wymaga ręcznego usunięcia.",
    },
  ...
  configView: {
    ...
    syncedHint: "Zsynchronizowane między urządzeniami przez Gateway.",
    notifications: {
  ...
  subtitles: {
    ...
    security: "Uwierzytelnianie Gateway, polityka exec, profil narzędzi i zatwierdzenia.",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange:
        "Formatowanie lub komentarze zmieniły się bez widocznych zmian ścieżek konfiguracji.",
      sources: {
  ...
  labsPage: {
    ...
    restartRequired: "Wymagany restart Gateway.",
    saveErrorTitle: "Nie można zaktualizować funkcji",
    saveFailed: "Nie udało się zapisać ustawienia funkcji.",
    codeMode: {
      title: "Tryb kodu",
      description:
        "Pozwól agentom łączyć narzędzia w zwartych, izolowanych przepływach pracy JavaScript.",
    },
    swarm: {
      title: "Swarm",
      description: "Pozwól trybowi kodu koordynować grupy subagentów równolegle.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Towarzysząca aplikacja na Androida rozszerza OpenClaw na Twój zegarek.",
      },
      macos: {
        title: "macOS",
        desc: "Towarzysz na pasku menu dla Twojego Gateway — powiadomienia, zatwierdzenia, szybki czat.",
      },
      windows: {
        title: "Windows",
        desc: "Towarzysząca aplikacja Windows łączy Twój komputer jako węzeł OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Pozwól OpenClaw sterować Twoim obecnym Chrome — kartami, stronami i formularzami.",
      },
      plugins: {
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Przełączanie odgałęzień wymaga dostępu administratora operatora.",
      untitledBranch: "Odgałęzienie bez tytułu",
    ...
    modelControls: {
      ...
      reasoning: "Rozumowanie",
      speed: "Prędkość",
      sessionOverride: "Zastąpienie wątku",
      usingDefault: "Używa domyślnych z Ustawień",
    ...
    composer: {
      ...
      microphoneAppliesNextSession: "Zmiany zostaną zastosowane przy następnej sesji Talk.",
      ...
      holdToRecordSettingDescription:
        "Przytrzymaj przycisk mikrofonu w polu tekstowym, mów, a następnie zwolnij, aby wstawić tekst bez wysyłania.",
      ...
      dictationProviderUnavailable:
        "Nie skonfigurowano żadnego dostawcy transkrypcji dla dyktowania.",
      ...
      selectedCameraUnavailable:
        "Wybrana kamera jest niedostępna. Wybierz inną kamerę lub domyślną kamerę systemu.",
