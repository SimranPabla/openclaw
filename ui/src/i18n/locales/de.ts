...
export const de: TranslationMap = {
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway auf allen Ihren Geräten synchronisiert.",
    notifications: {
      ...
      nativeBlockedHint:
        "Benachrichtigungen sind für OpenClaw in macOS deaktiviert. Erlauben Sie sie unter Systemeinstellungen > Benachrichtigungen.",
    },
    appearance: {
      theme: "Design",
    ...
    sidebarPrefs: {
      title: "Seitenleiste",
      hint: "Wählen Sie, was während laufender Sitzungen angezeigt wird.",
      liveActivity: "Live-Agentenaktivität in Seitenleiste anzeigen",
      liveActivityHint:
        "Zeigt die neueste Assistenten- oder Tool-Aktivität unter laufenden Sitzungen an.",
    },
    connection: {
      title: "Verbindung",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    connectionChanged:
      "Die Gateway-Verbindung hat sich geändert. Wiederholen Sie den Vorgang, um die Einrichtung fortzusetzen.",
    unsupportedGateway:
    ...
    nudge: {
      ...
      channelAuth: "Authentifizierung von {channel} beeinträchtigt — frag mich, was passiert ist",
  ...
  mcpPage: {
    connectorsLink: "Entdecken Sie One-Click-Konnektoren auf der Plugins-Seite.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  labsPage: {
    intro:
      "Labs enthält experimentelle Funktionen, die sich zwischen Releases ändern, fehlschlagen oder verschwinden können.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für Ihr Telefon, Ihre Uhr, Ihren Desktop und Browser – plus Plugins, um die Fähigkeiten Ihres Agenten zu erweitern.",
    ...
    badgeBundledIos: "Im Lieferumfang der iOS-App enthalten",
    badgeBundledAndroid: "Im Lieferumfang der Android-App enthalten",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatte, sprich, genehmige Aktionen und teile Inhalte von iOS aus in OpenClaw.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats auf einen Blick und Schnellantworten direkt vom Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "Die Windows-Companion-App verbindet deinen PC als OpenClaw-Node.",
      },
      linux: {
        title: "Linux",
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmailsDescription: "E-Mail-Adressen, die mit diesem Profil verbunden sind.",
  ...
  board: {
    ...
    emptyHint:
      "Ihr Agent kann hier Widgets anheften – bitten Sie zum Beispiel um eine Statuskarte.",
    ...
    widget: {
      ...
      errorDetail: "Das Problem ist auf diese Karte begrenzt.",
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Haupt",
      mockPlaceholder: "Board-Ansichtsnaht · {tabs} Tabs · {widgets} Widgets",
    ...
    questions: {
      ...
      submitFailed: "Konnte nicht gesendet werden: {error}",
    ...
    messages: {
      ...
      rewind: "Zurückspulen",
      rewindConfirm: "Zu einem Zeitpunkt vor dieser Nachricht zurückspulen?",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Halten Sie die Mikrofontaste im Editor gedrückt, sprechen Sie und lassen Sie los, um Text einzufügen, ohne zu senden.",
      ...
      dictationDisconnected: "Diktat gestoppt, da das Gateway die Verbindung getrennt hat.",
      dictationFailed: "Diktat fehlgeschlagen.",
      dictationFinalizing: "Diktat wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Diktat gestoppt, bevor der letzte Teiltranskript abgeschlossen werden konnte.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Widget-Export fehlgeschlagen. Bitte erneut versuchen.",
