...
export const ja_JP: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "ログアウトしました。",
      logoutNotCleared:
        "保存されたWhatsAppセッションは削除されませんでした。すでに存在しないか、認証ディレクトリを手動でクリーンアップする必要がある可能性があります。",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Gateway プロフィール",
  ...
  custodian: {
    ...
    earlier: "以前",
    requestFailed: "OpenClawが返信できませんでした。もう一度お試しください。",
    connectionChanged:
      "Gatewayの接続が変更されました。このセットアップを続けるには再試行してください。",
    ...
    history: {
      ...
      opaqueChange:
        "書式設定またはコメントが変更されましたが、表示される構成パスの変更はありません。",
      sources: {
  ...
  labsPage: {
    intro:
      "Labs には、リリース間で変更、破損、または消失する可能性のある実験的な機能が含まれています。",
    sectionTitle: "実験的機能",
    ...
    swarm: {
      title: "Swarm",
      description:
        "コードモードがサブエージェントのグループを並列でオーケストレーションできるようにします。",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOSからチャット、通話、操作の承認、OpenClawへの共有ができます。",
      },
      android: {
        title: "Android",
        desc: "Androidスマートフォンを完全なOpenClawノードとして活用 — チャット、カメラ、Canvas。",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "手元でひと目でチャットを確認し、すばやく返信できます。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Androidコンパニオンが腕時計にOpenClawを拡張します。",
      },
      macos: {
        title: "macOS",
      ...
      chrome: {
        title: "Chrome拡張機能",
        desc: "既存のChromeをOpenClawで操作 — タブ、ページ、フォームを制御します。",
      },
      plugins: {
        title: "プラグイン & ClawHub",
  ...
  profilePage: {
    ...
    identity: {
      title: "アイデンティティ",
      description: "このgatewayでのプロフィールです。",
      loading: "IDを読み込み中…",
      profileUnavailable: "IDプロフィールを読み込めませんでした。",
      avatar: "アバター",
      avatarDescription: "PNG、JPEG、またはWebP。画像は256 × 256以下にリサイズされます。",
      chooseAvatar: "画像を選択",
      processingAvatar: "処理中…",
      displayName: "表示名",
      displayNameDescription: "このgatewayを使用する他のユーザーに表示されます。",
      linkedEmails: "リンクされたメール",
      linkedEmailsDescription: "このプロフィールに接続されているメールアドレスです。",
      openSettings: "{name}のID設定を開く",
      avatarErrors: {
  ...
  chat: {
    ...
    messages: {
      ...
      rewindUnavailable: "エージェントの作業中は巻き戻しを利用できません",
      forkUnavailable: "エージェントの作業中はフォークを利用できません",
      unknownDate: "不明な日付",
      voiceNote: "ボイスメモ",
    },
    modelControls: {
