...
export const pt_BR: TranslationMap = {
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Dashboard disponível",
    approvalNeeded: "Aprovação necessária",
  ...
  subtitles: {
    ...
    custodian: "Configuração e cuidados do sistema.",
    ...
    labs: "Capacidades experimentais de agente e ferramentas.",
    ...
    advanced: "Todas as demais seções de configuração, além do editor de arquivos bruto.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "As alterações são salvas imediatamente e aplicadas às futuras execuções do agente.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicativos complementares para seu celular, relógio, computador e navegador — além de plugins para expandir o que seu agente pode fazer.",
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "O companion Android estende o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Companion na barra de menus para o seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
        desc: "O companion do Windows conecta seu PC como um nó do OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Deixe o OpenClaw operar seu Chrome atual — abas, páginas e formulários.",
      },
      plugins: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget do painel: {title}. Use as setas para navegar. Segure Alt e pressione uma seta para movê-lo.",
  ...
  chat: {
    ...
    board: {
      ...
      resetDescription: "O contexto da conversa é reiniciado. Seu painel permanece.",
    },
    catalog: {
    ...
    modelControls: {
      ...
      reasoning: "Raciocínio",
      speed: "Velocidade",
      sessionOverride: "Substituição do tópico",
    ...
    composer: {
      ...
      cameraInput: "Câmera",
      cameraListUnsupported: "Este navegador não pode listar câmeras.",
      cameraNoneFound: "Nenhuma câmera foi encontrada.",
      cameraPageInactive: "As câmeras não estão disponíveis enquanto esta página está inativa.",
