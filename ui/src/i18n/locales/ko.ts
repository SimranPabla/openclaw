...
export const ko: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count}개 스레드를 보관했습니다",
  ...
  subtitles: {
    ...
    advanced: "남은 모든 구성 섹션과 원시 파일 편집기.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  custodian: {
    ...
    history: {
      button: "기록",
      title: "최근 변경 사항",
      description: "이 시스템에서 변경된 내용을 최신 순으로 표시합니다.",
      loading: "최근 변경 사항을 불러오는 중…",
      empty: "아직 기록된 변경 사항이 없습니다.",
      requestFailed: "OpenClaw에서 변경 기록을 불러올 수 없습니다.",
      loadMore: "더 보기",
    ...
    nudge: {
      configReload: "구성 다시 불러오기가 중단되었습니다 — 무슨 일이 있었는지 물어보세요",
  ...
  mcpServers: {
    ...
    nameInvalid: "서버 이름에는 영문자, 숫자, 점, 대시, 밑줄을 사용합니다.",
    targetInvalid: "http(s) URL 또는 명령줄을 입력하세요.",
    nameTaken: "“{name}”(이)라는 MCP 서버가 이미 존재합니다.",
  ...
  mcpPage: {
    connectorsLink: "Plugins 페이지에서 원클릭 커넥터를 살펴보세요.",
    servers: "서버",
    oauth: "OAuth",
    filtered: "필터링됨",
  ...
  labsPage: {
    intro:
      "Labs에는 릴리스 간에 변경되거나 중단되거나 사라질 수 있는 실험적 기능이 포함되어 있습니다.",
    sectionTitle: "실험적 기능",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 컴팩트한 샌드박스 JavaScript 워크플로우에서 도구를 조합할 수 있도록 합니다.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode가 서브에이전트 그룹을 병렬로 오케스트레이션할 수 있도록 합니다.",
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 워치, 데스크톱, 브라우저용 컴패니언 앱 — 그리고 에이전트의 기능을 확장하는 플러그인까지.",
    sectionMobile: "휴대폰에서",
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmailsDescription: "이 프로필에 연결된 이메일 주소.",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동하세요. Alt를 누른 채 화살표 키를 누르면 위젯을 옮길 수 있습니다.",
      moveHandle: "{title} 이동",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "분기 전환에는 운영자 관리자 접근 권한이 필요합니다.",
    ...
    messages: {
      ...
      forkFromHere: "여기서 분기",
      hide: "숨기기",
      hideConfirm: "이 브라우저에서 이 메시지를 숨기시겠습니까? 에이전트는 여전히 볼 수 있습니다.",
      hideMessage: "메시지 숨기기",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "작성기의 마이크 버튼을 누른 채 말한 다음 놓으면 전송하지 않고 텍스트가 삽입됩니다.",
      ...
      dictationFinalizing: "받아쓰기를 완료하는 중…",
      dictationFinalizationTimedOut: "마지막 부분 전사를 완료하기 전에 받아쓰기가 중지되었습니다.",
      dictationProviderUnavailable: "받아쓰기에 사용할 전사 제공자가 구성되지 않았습니다.",
